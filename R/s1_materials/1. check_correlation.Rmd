...
```{r cars}
load('data_test/phenoflux_115.rda')
load('data_test/ET&GPP&VI_flux115.rda')
```
...
```{r}
st_97 <- fread("file:///F:/Github/phenology/phenofit/test/phenology_async/data/phenofit_st97.csv")
