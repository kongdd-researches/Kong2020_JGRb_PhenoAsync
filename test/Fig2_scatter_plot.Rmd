...
# source('../stable/ggplot/geom_boxplot_no_outlier.R')
library(tidyverse)
library(data.table)
library(magrittr)
library(phenofit)

source('R/s1_MCD12Q2.R')
source('R/main_Figs.R', encoding = "utf-8")

stations212 <- fread("data/st_flux212.txt")
stations    <- fread("data/phenofit_st97.csv")

load("data/phenofit_OUTPUT.rda")
