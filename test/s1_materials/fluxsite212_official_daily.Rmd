...
Test function first, than applied to all sites.
```{r}
...
# tidy_dd_official <- function(file, lat){
    ...
    x_qc  <- dt[, vars_QC , with = F] # 80% percentage available
    x_val[x_qc  < 0.8] <- NA
...
fwrite(df, paste0(dir_flux, 'fluxsites166_official_dd.csv'))
```
